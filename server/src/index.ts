...
// app.get("/isExists", async (req: Request, res: Response) => {
...
// async function getOtherUsers (socketId: string) {
//   const user = await prisma.user.findUnique({
//     where: {
//       socketId: socketId,
//     },
...
//   let roomId = user.roomName;
//   let ourFriend = await prisma.room.findUnique({
//     where: {
//       roomName: roomId,
//     },
//     include: {
...
//   let otherUsers = ourFriend?.users;
//   return otherUsers;
// }

// async function checkIfSameEmailExistsInRoom(email: string, roomId: string) {
//   const user = await prisma.user.findUnique({
//     where: {
//       email: email,
//       roomName: roomId
